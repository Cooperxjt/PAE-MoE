...
from AddLora.peft.tuners.addmoelora import set_runtime_task_id
...
def eval_model(args):
    ...
    if args.infer_task_id is not None:
        set_runtime_task_id(model, args.infer_task_id)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--infer_task_id", type=int, default=0)
