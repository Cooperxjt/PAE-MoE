sh scripts/LLaVA/Train_MOE/order_2/4_GQA.sh
sh scripts/LLaVA/Train_MOE/order_2/6_Grounding.sh
sh scripts/LLaVA/Train_MOE/order_2/3_ImageNet.sh
sh scripts/LLaVA/Train_MOE/order_2/8_OCRVQA.sh
sh scripts/LLaVA/Train_MOE/order_2/1_Science.sh
sh scripts/LLaVA/Train_MOE/order_2/2_TextVQA.sh
sh scripts/LLaVA/Train_MOE/order_2/5_VizWiz.sh
sh scripts/LLaVA/Train_MOE/order_2/7_vqav2.sh
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/4_eval_gqa.sh ./checkpoints/LLaVA/CoIN/ImageNet_llava_MOE_lora/
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/6_eval_grounding.sh ./checkpoints/LLaVA/CoIN/ImageNet_llava_MOE_lora/
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/4_eval_gqa.sh ./checkpoints/LLaVA/CoIN/ScienceQA_llava_add_MOE_lora/
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/6_eval_grounding.sh ./checkpoints/LLaVA/CoIN/ScienceQA_llava_add_MOE_lora/
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/3_eval_ImageNet.sh ./checkpoints/LLaVA/CoIN/ScienceQA_llava_add_MOE_lora/
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/8_eval_ocrvqa.sh ./checkpoints/LLaVA/CoIN/ScienceQA_llava_add_MOE_lora/
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/4_eval_gqa.sh ./checkpoints/LLaVA/CoIN/TextVQA_llava_add_MOE_lora/
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/6_eval_grounding.sh ./checkpoints/LLaVA/CoIN/TextVQA_llava_add_MOE_lora/
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/3_eval_ImageNet.sh ./checkpoints/LLaVA/CoIN/TextVQA_llava_add_MOE_lora/
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/8_eval_ocrvqa.sh ./checkpoints/LLaVA/CoIN/TextVQA_llava_add_MOE_lora/
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/6_eval_grounding.sh ./checkpoints/LLaVA/CoIN/VizWiz_llava_MOE_lora/
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/8_eval_ocrvqa.sh ./checkpoints/LLaVA/CoIN/VizWiz_llava_MOE_lora/
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/LLaVA/Eval/8_eval_ocrvqa.sh ./checkpoints/LLaVA/CoIN/VQAv2_llava_MOE_lora/