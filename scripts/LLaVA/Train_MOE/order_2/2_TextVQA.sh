...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --cur_task 6 \
    --task_layer_map_file ./layer_map/top_20.json \
    --model_name_or_path ./checkpoints/LLaVA/Vicuna/vicuna-7b-v1.5 \
    --previous_task_model_path ./checkpoints/LLaVA/CoIN/ScienceQA_llava_add_MOE_lora \
    ...
    --bf16 True \
    --output_dir ./checkpoints/LLaVA/CoIN/TextVQA_llava_add_MOE_lora \
    --num_train_epochs 1 \
